...
SELECT NOMBREARTÍCULO, SECCIÓN, PRECIO, round(PRECIO-(PRECIO*0.07),2) as Descuento_7  FROM  productos
...
SELECT FECHA, SECCIÓN, NOMBREARTÍCULO, PRECIO, round(PRECIO-2,2) as DTO2€_EN_CERÁMICA FROM productos
...
SELECT NOMBREARTÍCULO, SECCIÓN, PRECIO, round(PRECIO*1.02,2) as PRECIO_AUMENTADO_EN_2 FROM productos
